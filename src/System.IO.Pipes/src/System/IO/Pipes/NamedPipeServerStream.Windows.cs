...
namespace Backports.System.IO.Pipes
{
    ...
    public sealed partial class NamedPipeServerStream : PipeStream
    {
                ...
                PipeSecurity? pipeSecurity, HandleInheritability inheritability, PipeAccessRights additionalAccessRights)
        {
            ...
            try
            {
                Interop.Kernel32.SECURITY_ATTRIBUTES secAttrs = GetSecAttrs(inheritability, null, ref pinningHandle);
        ...
        public unsafe string GetImpersonationUserName()
        {
            ...
            return HandleGetImpersonationUserNameError(MarshalHelpers.GetLastPInvokeError(), UserNameMaxLength, userName);
        }
        ...
        private static void ImpersonateAndTryCode(object? helper)
        {
            ...
            {
                execHelper._impersonateErrorCode = MarshalHelpers.GetLastPInvokeError();
            }
        ...
        private static void RevertImpersonationOnBackout(object? helper, bool exceptionThrown)
        {
            ...
            if (execHelper._mustRevert)
            {
                ...
                {
                    execHelper._revertImpersonateErrorCode = MarshalHelpers.GetLastPInvokeError();
                }
            }
        }
                ...
                if (!Interop.Kernel32.ConnectNamedPipe(InternalHandle!, vts._overlapped))
                {
                    ...
                    switch (errorCode)
                    {
                        ...
                        case Interop.Errors.ERROR_PIPE_CONNECTED:
                            ...
                            {
                                return ValueTaskHelpers.FromException(ExceptionDispatchInfoHelpers.SetCurrentStackTrace(new InvalidOperationException(SR.InvalidOperation_PipeAlreadyConnected)));
                            }
                            State = PipeState.Connected;
                            return ValueTaskHelpers.CompletedTask;

                        default:
                            vts.Dispose();
                            return ValueTaskHelpers.FromException(ExceptionDispatchInfoHelpers.SetCurrentStackTrace(Win32Marshal.GetExceptionForWin32Error(errorCode)));
                    }
                }
            }
            catch
